...
## ✨ Key Features
  ...
  * **AI Writing Assistant**: Integrates LLMs via Pydantic AI (switchable provider: NVIDIA NIM or Google Gemini), providing text summarization, polishing, structured proofreading, document analysis, and document Q&A features to enhance writing efficiency.
...
### Backend
  ...
  * **Dependencies**:
      ...
      * `channels`
      * `channels-redis`
      * `pydantic-ai-slim[openai,google]` (AI features, switchable NVIDIA NIM / Gemini provider)
...
### Prerequisites
  ...
  * [Node.js](https://nodejs.org/) 24+ and npm (or pnpm/yarn)
